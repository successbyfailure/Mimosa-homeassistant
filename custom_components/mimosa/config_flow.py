        ...
        data_schema = vol.Schema(
            {
                ...
                vol.Optional(CONF_ENABLE_SIGNALS, default=options.get(CONF_ENABLE_SIGNALS, True)): bool,
                vol.Optional(CONF_ENABLE_HEATMAP, default=options.get(CONF_ENABLE_HEATMAP, False)): bool,
                vol.Optional(CONF_ENABLE_RULES, default=options.get(CONF_ENABLE_RULES, True)): bool,
                vol.Optional(CONF_ENABLE_FIREWALL_RULES, default=options.get(CONF_ENABLE_FIREWALL_RULES, False)): bool,
